...
<div class="container">
  ...
  <div class="row">
          ...
          <%
          Integer nropizza=99;
 		 String nompizza="pas de pizza" ; 
 		 Float prixpizza=(float)9000.0 ; 
...
<br><br>
  ...
  <form name="monform" action="recup.jsp" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nom" name="nom"  value="<%=nompizza %>">
    </div>
    <div class="form-group">
	  ...
	  <input type="text" class="form-control" id="tarif" name="tarif" value=<%=prixpizza  %>>
